        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "- SEARCH: get knowledge for simple topics and casual information\n"
                    ...
                    "3: {action_type: 'PREPARE', message: 'create complete html code which uses previously researched data and write in one code file'}, "
